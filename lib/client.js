    ...
    function apply(ctx) {
      ...
      style.textContent = `
        ...
        .ds-oc-pct {
          ...
          font-size: 11px;
          font-family: "MiSans", "MiSan", "Microsoft YaHei", "Microsoft YaHei UI", "微软雅黑", sans-serif;
          ...
          try {
            ...
            fetch(USAGE_PATH, opts)
              ...
              .then((res) => {
                ...
                if (loadAbort.current === ctrl) loadAbort.current = null;
              ...
              .catch((err) => {
                ...
                setState({ status: "error", data: null, error: { message: String(err && err.message ? err.message : err) } });
                scheduleRetry();
              });
          } catch (err) {
            setState({ status: "error", data: null, error: { message: String(err && err.message ? err.message : err) } });
